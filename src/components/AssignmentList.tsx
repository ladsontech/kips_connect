        ...
        <div key={assignment.id} className="rounded-2xl border border-slate-200 bg-white p-4">
          ...
          {assignment.status === 'assigned' && onStartSurvey && (
            <button
              ...
              className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-xl bg-kibs-deepGreen py-2.5 text-xs font-black text-white transition hover:bg-emerald-700"
            >
              Start Survey
          ...
          {assignment.status === 'completed' && assignment.surveyId && onViewSurvey && (
            <button
              ...
              className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-xl border border-emerald-200 bg-emerald-50 py-2.5 text-xs font-bold text-emerald-700 transition hover:bg-emerald-100"
            >
