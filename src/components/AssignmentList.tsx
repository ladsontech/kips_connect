        ...
        <div key={assignment.id} className="rounded-2xl border border-slate-200 bg-white p-4">
          ...
          {assignment.status === 'assigned' && onStartSurvey && (
            <button
              ...
              className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-xl bg-kibs-deepGreen py-2.5 text-xs font-black text-white transition hover:bg-green-800"
            >
              Start Survey
          ...
          {assignment.status === 'completed' && assignment.surveyId && onViewSurvey && (
            <button
              ...
              className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-xl border border-kibs-deepGreen/20 bg-kibs-deepGreen/5 py-2.5 text-xs font-bold text-kibs-deepGreen transition hover:bg-kibs-deepGreen/10"
            >
