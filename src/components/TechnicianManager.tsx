  ...
  return (
    <div className="space-y-2.5">
      {technicians.map((technician) => {
        ...
        return (
          <div key={technician.id} className="rounded-2xl border border-slate-200 bg-white p-4">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-kibs-green/15 text-kibs-deepGreen">
